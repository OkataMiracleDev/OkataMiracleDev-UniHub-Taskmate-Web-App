...
const TeamMemberDashboard = () => {
  ...
  // FIX: Wrap fetchTasks and fetchAnalytics in useCallback to satisfy ESLint hook dependency rule
  ...
  useEffect(() => {
    ...
    fetchTasks();
    fetchAnalytics();
  }, [userRole, navigate, API_URL, fetchTasks, fetchAnalytics]); // FIX: Add the functions to the dependency array
