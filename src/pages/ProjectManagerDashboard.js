...
            // Fetch team members
            const membersRes = await axios.get(`${API_URL}/api/users/team`, {
                headers: { Authorization: `Bearer ${token}` }
            });
            setTeamMembers(membersRes.data);

            // Fetch tasks
            const tasksRes = await axios.get(`${API_URL}/api/tasks/assigned`, {
                headers: { Authorization: `Bearer ${token}` }
            });
            setTasks(tasksRes.data);

            // Fetch analytics
            const analyticsRes = await axios.get(`${API_URL}/api/tasks/analytics/manager`, {
                headers: { Authorization: `Bearer ${token}` }
            });
