...
// FIX: Use the environment variable directly.
...
    try {
      // FIX: Create a FormData object to send the file and other form data.
      const formData = new FormData();
      formData.append('name', name);
      formData.append('email', email);
      formData.append('password', password);
      formData.append('role', role);
      formData.append('profilePhoto', profilePhoto); // Append the actual file object.

      if (role === 'Team Member' && teamCode) {
        formData.append('teamCode', teamCode);
      }
      
      // FIX: Use the correct endpoint for registration.
      // We use /api because your backend is structured that way.
      // Axios with FormData automatically sets the correct 'Content-Type' header.
...
    try {
      // FIX: Use the correct login endpoint.
